      PROGRAM RMOLECASC
c     SSL: added "alpha" for compatibility with Castelli format
c     revised 30sep15   MgO and CaO added
...
C
 ...
 1111 FORMAT(F10.4,F7.3,F5.1,F10.3,F5.1,F11.3,I4,A8,A8,I2,I4)
      IF(MOD(ILINE,10000).EQ.1)PRINT 1234,ILINE,WL
 1234 FORMAT(I10,F11.4)
